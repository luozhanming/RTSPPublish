...
public class StreamConnection extends TCPConnection {
    ...
    protected final int QUEUE_READ_TIMEOUT = 2000;      // Timeout to read from the queue in ms

    private final ArrayBlockingQueue<VideoFrame> mFrameQueue // The queue used to send uncompressed video frames
            = new ArrayBlockingQueue<>(QUEUE_CAPACITY); //
    private final ArrayBlockingQueue<VideoFrame> mSliceQueue // The queue used to send compressed slices
            = new ArrayBlockingQueue<>(QUEUE_CAPACITY); //
    private final ArrayBlockingQueue<AudioData> mAudioQueue  // The queue used to send compressed audio
            = new ArrayBlockingQueue<>(QUEUE_CAPACITY); //
